...
namespace app.MD5 {
   ...
   */
  export function hex_md5(s: string) { return rstr2hex(rstr_md5(str2rstr_utf8(s))); }
  export function b64_md5(s: string) { return rstr2b64(rstr_md5(str2rstr_utf8(s))); }
  export function any_md5(s: string, e: string) { return rstr2any(rstr_md5(str2rstr_utf8(s)), e); }
  export function hex_hmac_md5(k: string, d: string)
  { return rstr2hex(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
  export function b64_hmac_md5(k: string, d: string)
  { return rstr2b64(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
  export function any_hmac_md5(k: string, d: string, e: string)
   ...
   */
  function binl_md5(x: any, len: number): number[] {
    /* append padding */
    x[len >> 5] |= 0x80 << ((len) % 32);
    x[(((len + 64) >>> 9) << 4) + 14] = len;
